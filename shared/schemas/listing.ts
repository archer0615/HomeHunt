...
export const listingSchema = z.object({
  ...
  minTotalPrice: money.optional(),
  maxTotalPrice: money.optional(),
  minUnitPrice: optionalNumber,
  maxUnitPrice: optionalNumber,
  buildingArea: area.optional(),
  minBuildingArea: area.optional(),
  maxBuildingArea: area.optional(),
  mainArea: area.optional(),
  auxiliaryArea: area.optional(),
  indoorArea: area.optional(),
  commonArea: area.optional(),
  commonAreaRatio: optionalNumber,
  landArea: area.optional(),
  rooms: optionalInteger,
  minRooms: optionalInteger,
  maxRooms: optionalInteger,
  ...
  parkingIncludedInPrice: z.boolean().optional(),
  managementFee: money.optional(),
  ...
  missingSince: isoDateTime.optional(),
  delistedAt: isoDateTime.optional(),
  relistCount: z.number().int().nonnegative(),
  missingSuccessCount: z.number().int().nonnegative(),
  contentHash: z.string().min(1),
  rawDataHash: z.string().min(1),
...
export const listingEventSchema = z.object({
  id: z.string().min(1),
  listingId: z.string().min(1),
  eventType: z.enum(listingEventTypes),
