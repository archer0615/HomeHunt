...
export function sourceCityId(
  sourceId: keyof typeof PRODUCTION_SCOPE.sources,
  city: ProductionCity,
): string {
  return PRODUCTION_SCOPE.sources[sourceId].cities[city];
}

export function isProductionDistrict(
  city: string | undefined,
  district: string | undefined,
): boolean {
  return (
    isProductionCity(city) &&
    district !== undefined &&
    PRODUCTION_DISTRICTS[city].includes(district)
  );
}
...
export function isMoiTransactionInRollingWindow(
